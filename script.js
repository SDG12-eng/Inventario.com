...
// ==========================================
// 2. VARIABLES GLOBALES (Garantizadas)
// ==========================================
...
// ==========================================
// 3. DEFINICIÓN DE TODAS LAS FUNCIONES (HOISTING SEGURO)
// ==========================================
...
window.actualizarDashboard = function() {
    ...
    if(panelFiltros && window.tienePermiso('dashboard', 'gestionar')) {
        if(!document.getElementById("btn-excel-dashboard")) {
            panelFiltros.insertAdjacentHTML('beforeend', `<button id="btn-excel-dashboard" onclick="window.descargarReporte()" class="bg-emerald-600 text-white px-4 py-2 rounded-lg text-xs font-bold shadow hover:bg-emerald-700 transition"><i class="fas fa-file-excel"></i> Exportar</button>`);
        }
...
window.renderHistorialUnificado = function() {
    ...
    if(panelFiltros && window.tienePermiso('historial', 'gestionar')) {
        if(!document.getElementById("btn-excel-historial")) {
            panelFiltros.insertAdjacentHTML('beforeend', `<button id="btn-excel-historial" onclick="window.descargarReporte()" class="bg-emerald-600 text-white px-4 py-2 rounded-lg text-xs font-bold shadow hover:bg-emerald-700 ml-2"><i class="fas fa-file-excel"></i> Exportar Todo</button>`);
        }
...
window.renderCompras = function() {
    ...
    const tb = document.getElementById("lista-compras-db"); if(!tb) return;
    let html = "";
...
// ==========================================
// 13. INICIALIZACIÓN FINAL Y CLOUDINARY
// ==========================================
